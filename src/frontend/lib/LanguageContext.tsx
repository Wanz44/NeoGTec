...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'contracts.calc_algorithm_desc': 'Notre moteur algorithmique analyse le risque historique pour suggérer les meilleurs plafonds par segment démographique.',
  ...
  en: {
    ...
    'contracts.calc_algorithm_desc': 'Our algorithmic engine analyzes historical risk factors to suggest the best ceilings by demographic segment.',
  ...
  pt: {
    ...
    'contracts.calc_algorithm_desc': 'Nosso motor de algoritmo analisa o risco com base no histórico para sugerir os melhores tetos por segmento demográfico.',
