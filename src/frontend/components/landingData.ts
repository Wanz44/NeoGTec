...
export const modulesList: ModuleItem[] = [
  ...
  { id: 9, type: "Add-on", name: "Détecteur de Fraude Algorithmique", benefit: "Repère les sur-prescriptions de médicaments.", price: 250, desc: "Analyse en direct pour interdire les ordonnances fictives et les rachets d'assurés." },
