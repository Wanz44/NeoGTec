...
import {
  ...
  ScanFace, LogOut, Check, PieChart, FileWarning, HeartPulse, MessageCircle, Upload, Paperclip, PanelLeftClose, PanelLeftOpen, Eye, EyeOff, KeyRound, ChevronUp, AlertCircle,
} from "lucide-react";
...
function SignIn({ prefill, onDone, onGoSignUp }) {
  ...
  const handleSendResetCode = (e) => {
    e.preventDefault();
    if (!forgotEmail) { setForgotError("Veuillez saisir votre email professionnel."); return; }
    setForgotError("");
    setForgotLoading(true);
    setTimeout(() => {
      setForgotLoading(false);
      setForgotStep(2);
      setForgotSuccess("Un code de vérification à 6 chiffres a été transmis à votre adresse email RH.");
    }, 800);
  };
        ...
        <div className="w-full md:w-7/12 p-6 sm:p-8 flex flex-col justify-between bg-[#0A1F13]/80">
          {!forgotMode ? (
            <div>
              ...
              <button
                type="button"
                onClick={() => fillTestAccount("rh@entreprise.cd", "123456")}
              ...
              <div className="mt-5 border border-[#C6992E]/30 rounded-2xl bg-[#C6992E]/10 overflow-hidden">
                ...
                {showTestAccounts && (
                  <div className="p-3 border-t border-[#C6992E]/20 space-y-1.5 text-xs bg-[#06140B]/80">
                    ...
                    >
                      <div>
                        <div className="font-semibold text-white">Gestionnaire RH Entreprise</div>
                        <div className="text-[11px] text-[#B9C3D6]">rh@entreprise.cd</div>
                      </div>
              ...
              <div className="mt-6 space-y-3">
                ...
                >
                  ...
                  {loading ? "Connexion en cours…" : "Se connecter à l'Espaceentreprise"}
                </button>
            ...
            <div className="h-full flex flex-col justify-between">
              <div>
                ...
                <div className="mb-6">
                  ...
                  <h2 style={{ fontFamily: serif, fontSize: 22, color: "white", fontWeight: 700 }}>
                    Mot de passe oublié RH
                  </h2>
                  <p style={{ fontFamily: sans, fontSize: 12, color: "#B9C3D6", marginTop: 4 }}>
                    Réinitialisez l'accès sécurisé à votre portail Entreprise.
                  </p>
                </div>
                ...
                {forgotStep === 1 && (
                  <form onSubmit={handleSendResetCode} className="space-y-4">
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          placeholder="ex : rh@entreprise.cd"
                        />
                        <Mail size={15} className="absolute left-3 top-3.5 text-[#B9C3D6]" />
                      </div>
                    </div>
                    ...
                    >
                      {forgotLoading ? <Loader2 size={16} className="animate-spin" /> : "Envoyer le code RH de sécurité"}
                    </button>
                  </form>
                )}
                  ...
                  <form onSubmit={handleResetPassword} className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="ex: 930182"
                      />
                    </div>

                    <div>
                      <label style={{ fontFamily: sans, fontSize: 11, fontWeight: 700, color: C.gold }} className="block mb-1">
                        NOUVEAU MOT DE PASSE GESTIONNAIRE
                      </label>
                      <input
                        style={inputStyle}
                        type="password"
                    ...
                    <button
                      ...
                      style={{ background: C.gold, color: C.navy }}
                    >
                      {forgotLoading ? <Loader2 size={16} className="animate-spin" /> : "Réinitialiser le mot de passe RH"}
                    </button>
                  </form>
                )}
                ...
                {forgotStep === 3 && (
                  <div className="text-center py-6 space-y-4">
                    ...
                    <h3 className="text-lg font-bold text-white">Accès RH Réinitialisé !</h3>
                    <p className="text-xs text-[#B9C3D6] max-w-xs mx-auto">
                      Le mot de passe de votre compte Entreprise a été mis à jour avec succès.
                    </p>
                    <button
                      type="button"
                      onClick={() => setForgotMode(false)}
